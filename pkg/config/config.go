...
type PodLogLimits struct {
	...
	// If set, take into account the corresponding pod logs
	// This is an array of FieldSelector, each of them follows the definition as K8s field selector
	...
	// using the same format as k8s.io/apimachinery/pkg/apis/meta/v1/types/ListOptions/FieldSelector.
...
func New() *Config {
	...
	cfg.Limits.PodLogs.FieldSelectors = []string{} //TODO: check
